...
const stripe = require('stripe')('sk_test_51PnXScFd0LnzjZc5DYxhtUNb4NYuxuOEUdxFaP4GPNSTVCMod2tEc454dXJlDS8d2YiHzK1pXtbwgTRyLnTqDrfB00Q5r6IiSq')
...
exports.getCheckout = (req, res, next) => {
    ...
    .then( user => {
        ...
        })/* //obj changed below is correct
        return stripe.checkout.sessions.create({
            payment_method_types: ['card'],
            line_items: products.map(p => {
               return{ //stripes want in this format
            ...
            }),//redirect url once transc cmplt or failed
            //dynamic derive the url 
