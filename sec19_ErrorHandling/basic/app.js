...
const MONGODB_URI = 'mongodb+srv://Nodejs:Nodejspassword@cluster0.rj3wp52.mongodb.net/validation?retryWrites=true&w=majority&appName=Cluster0'
const app = express();
...
app.use((req, res, next) => {
  console.log("inside session check middleware")
